...
const ProjectDetails = () => {
    ...
    const handleDelete = () => {
        if (window.confirm('Are you sure you want to delete this project? All tasks in this project will be permanently deleted.')) {
    ...
    if (isError || !project) {
        return <div className="text-center text-red-500 dark:text-red-400">Error loading project</div>;
    }

    return (
        <div className="space-y-6">
            <div className="flex items-center space-x-4">
                <button onClick={() => navigate('/projects')} className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-colors text-gray-500 dark:text-gray-400">
